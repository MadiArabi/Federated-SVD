...
for randomness in range(15):
    ...
    for rank in D:
        ...
        for k in K:
            ...
            for index in range(0,5):
                ...
                ##################Modeling: 
                model = LM.fit(PCscores, np.log(tray[0:43]))
    ...
    ##################Modeling: 
    model = LM.fit(PCscores, np.log(Y1))
    ...
    abs_errors.to_csv(r'G:\My Drive\research1\simultaed\user170159.csv', encoding='utf-8', index=False, mode='a')
