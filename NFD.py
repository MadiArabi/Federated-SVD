...
'''
missingindices = np.random.choice(150*120, size=int(120*150*0.3), replace=False) # missing level
X=X.ravel()
X[missingindices] = 0
...
for randomness in range(15):
        ...
        for k in K:
            ...
            for index in range(0,5):
                ...
                for i in range(20): # 10 cycles
                    u = basis_construction(0,n1+n2+n3,user,u,d,n)
                   
                    
                    
                ###########user1:
                b1=weight_matrix(0,n1+n2+n3,user,u,d,n)
                ...
                #####user1
                b1=weight_matrix(0,n1+n2+n3,usertst,u,d,n)
    ...
    for _ in range(100): # 10 cycles
        resnorm =0
        u = basis_construction(0,n1+n2+n3,x,u,d,n)
        
        resnorm = resnorm_clac(0,n1+n2+n3,x,u,d,n,resnorm)
    ...
    ###########user1:
    b1=weight_matrix(0,n1+n2+n3,x,u,d,n)
    ...
    b1=weight_matrix(0,nd,Xtest,u,d,n)
    ...
    abs_errors.to_csv(r'G:\My Drive\research1\simultaed\NFD30159.csv', encoding='utf-8', index=False, mode='a')
